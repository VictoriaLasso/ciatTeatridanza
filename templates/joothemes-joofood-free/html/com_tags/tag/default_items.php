...
");
?>
<form action="<?php echo htmlspecialchars(JUri::getInstance()->toString()); ?>" method="post" name="adminForm" id="adminForm" class="form-inline tag-form">
...
<a href="<?php echo JRoute::_(TagsHelperRoute::getItemRoute($item->content_item_id, $item->core_alias, $item->core_catid, $item->core_language, $item->type_alias, $item->router)); ?>">
	<?php
echo '<div class="image-container blog-article-img">';  ?>
	<img class="scale" src="<?php echo htmlspecialchars($images->image_intro); ?>"  alt="<?php echo htmlspecialchars($images->image_intro_alt); ?>" />
...
<h2><a href="<?php echo JRoute::_(TagsHelperRoute::getItemRoute($item->content_item_id, $item->core_alias, $item->core_catid, $item->core_language, $item->type_alias, $item->router)); ?>">
<?php echo $this->escape($item->core_title); ?></a></h2>
	<div class="intro-article">
			...
			$text=(substr(strip_tags($item->text), 0, $limit)) . " ... ";
			$result = preg_replace("/\<\/?[A-Za-z\-\_]+\>/", "", $text);
			echo $result;
		...
		<?php if ($col % 3 == 0){echo "<div class='col-sm-12 hidden-xs'><div class='separator-line col-sm-12'></div></div>";} ?>
		<?php endforeach; ?>
	</div>
