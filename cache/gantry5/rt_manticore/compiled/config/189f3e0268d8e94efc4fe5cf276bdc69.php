...
return [
    ...
    'checksum' => '11a6e49560d3d353b355c6645d471b85',
    'files' => [
        'templates/rt_manticore/custom/config/300' => [
            'assignments' => [
                'file' => 'templates/rt_manticore/custom/config/300/assignments.yaml',
                'modified' => 1595887357
            ],
            'index' => [
                'file' => 'templates/rt_manticore/custom/config/300/index.yaml',
                'modified' => 1595974743
            ],
            'layout' => [
                'file' => 'templates/rt_manticore/custom/config/300/layout.yaml',
                'modified' => 1595974743
            ],
            'page/assets' => [
                'file' => 'templates/rt_manticore/custom/config/300/page/assets.yaml',
                'modified' => 1595717263
            ],
            'page/body' => [
                'file' => 'templates/rt_manticore/custom/config/300/page/body.yaml',
                'modified' => 1595717263
            ],
            'styles' => [
                'file' => 'templates/rt_manticore/custom/config/300/styles.yaml',
                'modified' => 1595975015
            ]
        ],
    ...
    'data' => [
        ...
        'styles' => [
            'above' => [
                'background' => 'rgba(78, 38, 122, 0.53)',
                'text-color' => '#000000'
            ],
            'accent' => [
                'color-1' => '#751508'
            ...
            'base' => [
                'background' => 'rgba(255, 217, 0, 0.68)',
                'text-color' => '#030303',
            ...
            'breakpoints' => [
                'large-desktop-container' => '100rem',
            ...
            'font' => [
                'family-default' => 'family=Jolly+Lodger'
            ],
            'footer' => [
                'background' => '#000000',
                'text-color' => '#888888'
            ...
            'menu' => [
                'animation' => 'g-dropdown-bounce-in-down'
            ],
            'menustyle' => [
                'background' => '#000000',
                'text-color' => '#c2c3c6',
                'text-color-alt' => '#c2c3c6',
                'text-color-active' => 'rgba(10, 10, 3, 0.72)',
                'background-active' => '#ffffff',
                'sublevel-text-color' => '#ffffff',
                'sublevel-text-color-active' => '#000000',
                'sublevel-background' => '#eb3915',
            ...
            'offcanvas' => [
                'background' => 'rgba(14, 86, 240, 0.55)',
                'text-color' => '#ffffff',
                'toggle-color' => '#1e00e0',
                'width' => '20rem',
                'toggle-visibility' => '2'
        ...
        'page' => [
            ...
            'assets' => [
                'favicon' => 'gantry-media://ciat2.jpg',
                'touchicon' => 'gantry-media://ciat8.png',
                'css' => [
        ...
        'layout' => [
            ...
            'content' => [
                'logo-2704' => [
                    'title' => 'Logo / Image',
                    'attributes' => [
                        'image' => 'gantry-media://ciat4.png',
                        'link' => '1',
                        'text' => 'Ciat Teatridanza',
                        'title' => 'Teatro de la Montaña',
                    ...
                    'attributes' => [
                        ...
                        'items' => [
                            0 => [
                                ...
                                'linktarget' => '_self',
                                'author_image' => '',
                                'author_text' => 'El ciat es un lugar itinerante',
                                'author_link' => '#',
